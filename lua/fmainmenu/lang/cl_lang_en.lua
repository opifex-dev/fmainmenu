...
FMainMenu.LangPresets[prefix].ConfigCommonValueCancel = "Cancel"
...
FMainMenu.LangPresets[prefix].ConfigPropertiesPanelDermaPropName = "Frame Style"
FMainMenu.LangPresets[prefix].ConfigPropertiesPanelDermaPropDesc = "Control how various aspects of\nthe frames and panels are styled."
FMainMenu.LangPresets[prefix].ConfigPropertiesPanelDermaPanelColor = "Panel Color: "
FMainMenu.LangPresets[prefix].ConfigPropertiesPanelDermaButtonColor = "Button Color: "
FMainMenu.LangPresets[prefix].ConfigPropertiesPanelDermaTextColor = "Text Color"
FMainMenu.LangPresets[prefix].ConfigPropertiesPanelDermaFrameColor = "Frame Color"

FMainMenu.LangPresets[prefix].ConfigPropertiesConfigAccessPropName = "Config Access"
FMainMenu.LangPresets[prefix].ConfigPropertiesConfigAccessPropDesc = "Control who can view and edit\nthe fmainmenu configuration."
FMainMenu.LangPresets[prefix].ConfigPropertiesConfigAccessToggleLabel = "Config Access Group: "

FMainMenu.LangPresets[prefix].ConfigPropertiesAdvancedGeneralInfoButtonLabel = "Get Information"
...
FMainMenu.LangPresets[prefix].ConfigPropertiesConfigFirstJoinSeedPropName = "First Join Seed"
FMainMenu.LangPresets[prefix].ConfigPropertiesConfigFirstJoinSeedPropDesc = "Control how the first join seed\ndetects who has viewed it."
FMainMenu.LangPresets[prefix].ConfigPropertiesConfigFirstJoinSeedBoxLabel = "First Join Seed: "
FMainMenu.LangPresets[prefix].ConfigPropertiesFirstJoinSeedInfoLabel = "For more information on the first\njoin seed, click the button below"
FMainMenu.LangPresets[prefix].ConfigPropertiesFirstJoinSeedInfo = "To detect when a player has gone through the \"Welcome Screen\" dialog, a file is created with a name based on the IP of the server. This allows multiple servers to have this addon without conflicts.\nIn cases when an IP might not be available, such as in peer-to-peer servers, the \"First Join Seed\" property should be set to something unique so as to not conflict with other servers.\n\nHaving the property be blank will cause the addon to use normal IP-based naming procedures."
FMainMenu.LangPresets[prefix].ConfigPropertiesFirstJoinSeedInfoWindowTitle = "First Join Seed Information"

FMainMenu.LangPresets[prefix].ConfigPropertiesMenuOverridePropName = "Custom Layout"
FMainMenu.LangPresets[prefix].ConfigPropertiesMenuOverridePropDesc = "Control how the menu buttons are\nlaid out."
FMainMenu.LangPresets[prefix].ConfigPropertiesMenuOverrideOptLabel = "Custom Layout: "
FMainMenu.LangPresets[prefix].ConfigPropertiesMenuSetupEditorButtonLabel = "Edit Layout"
FMainMenu.LangPresets[prefix].ConfigPropertiesMenuOverrideInfoLabel = "For more information on custom\nlayouts, click the button below"
FMainMenu.LangPresets[prefix].ConfigPropertiesMenuOverrideInfo = "Custom layouts allow servers to have more control over the placement of buttons under the logo.\n\nWhen enabled, the \"Disconnect Button\" and \"URL Buttons\" properties will be ignored."
FMainMenu.LangPresets[prefix].ConfigPropertiesMenuOverrideInfoWindowTitle = "Custom Layout Information"
FMainMenu.LangPresets[prefix].ConfigMenuSetupEditorWindowTitle = "Menu Layout Editor"
FMainMenu.LangPresets[prefix].ConfigMenuSetupEditorTypePlay = "Play Button"
FMainMenu.LangPresets[prefix].ConfigMenuSetupEditorTypeSpacer = "Spacer"
FMainMenu.LangPresets[prefix].ConfigMenuSetupEditorTypeURL = "URL Button"
FMainMenu.LangPresets[prefix].ConfigMenuSetupEditorTypeDisconnect = "Disconnect Button"
FMainMenu.LangPresets[prefix].ConfigMenuSetupEditorWindowChooseTypeLabel = "Choose Button Type"
