...
net_Receive( "FMainMenu_Config_OpenMenu", function( len )
	...
	if FMainMenu.CurConfigMenu == nil then
		...
		FMainMenu.CurConfigMenu.configUnsavedBlocker.innerPanel = vgui_Create("fmainmenu_config_editor_panel", FMainMenu.CurConfigMenu.configUnsavedBlocker)
		FMainMenu.CurConfigMenu.configUnsavedBlocker.innerPanel:SetSize( 240, 50 )
		FMainMenu.CurConfigMenu.configUnsavedBlocker.innerPanel:AlignTop(67.5)
		FMainMenu.CurConfigMenu.configUnsavedBlocker.innerPanel:SetBGColor(Color(75,45,45,240))
		FMainMenu.CurConfigMenu.configUnsavedBlocker.innerTextOne = vgui_Create("fmainmenu_config_editor_label", FMainMenu.CurConfigMenu.configUnsavedBlocker.innerPanel)
		FMainMenu.CurConfigMenu.configUnsavedBlocker.innerTextOne:SetText(FMainMenu.GetPhrase("ConfigBlackerUnsavedLineOne"))
		FMainMenu.CurConfigMenu.configUnsavedBlocker.innerTextOne:SetSize(240, 25)
		FMainMenu.CurConfigMenu.configUnsavedBlocker.innerTextOne:SetFont("HudHintTextLarge")
		FMainMenu.CurConfigMenu.configUnsavedBlocker.innerTextOne:SetContentAlignment(5)
		FMainMenu.CurConfigMenu.configUnsavedBlocker.innerTextOne:AlignTop(2)
		FMainMenu.CurConfigMenu.configUnsavedBlocker.innerTextTwo = vgui_Create("fmainmenu_config_editor_label", FMainMenu.CurConfigMenu.configUnsavedBlocker.innerPanel)
		FMainMenu.CurConfigMenu.configUnsavedBlocker.innerTextTwo:SetText(FMainMenu.GetPhrase("ConfigBlackerUnsavedLineTwo"))
		FMainMenu.CurConfigMenu.configUnsavedBlocker.innerTextTwo:SetSize(240, 25)
		FMainMenu.CurConfigMenu.configUnsavedBlocker.innerTextTwo:SetFont("HudHintTextLarge")
		FMainMenu.CurConfigMenu.configUnsavedBlocker.innerTextTwo:SetContentAlignment(5)
		FMainMenu.CurConfigMenu.configUnsavedBlocker.innerTextTwo:AlignTop(23)
		...
		topInfoBarCloseButton.DoClick = function(button)
			if !FMainMenu.CurConfigMenu.unsavedVar then
				...
				closeQuestionLabel:SetPos(10, 30)
				local closeQuestionLabelTwo = vgui_Create("fmainmenu_config_editor_label", closeCheck)
				closeQuestionLabelTwo:SetText(FMainMenu.GetPhrase("ConfigUnsavedChangesTwo"))
				closeQuestionLabelTwo:SetSize(280,125)
				closeQuestionLabelTwo:SetContentAlignment(8)
				closeQuestionLabelTwo:SetPos(10, 50)
